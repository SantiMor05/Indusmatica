...
void construir(struct Lista & tad) {
    tad.cabeza = nullptr;
    tad.colaCat1 = nullptr; /*Esto se debe añadir*/
    tad.colaCat3 = nullptr; /*Esto se debe añadir*/
    tad.colaCat2 = nullptr; /*Esto se debe añadir*/
    tad.longitud = 0;
}
...
void eliminaCabeza(struct Lista & tad) {
    ...
    if (nodoAEliminar != nullptr) {
        ...
        if (tad.cabeza == nullptr) /*falta añadir para que coloque*/{
            tad.colaCat1 = nullptr; /*cola en null*/
            tad.colaCat2 = nullptr; /*cola en null*/
            tad.colaCat3 = nullptr; /*cola en null*/
        }
...
void insertar_Prioridad(struct Lista & tad, const struct Elemento & elemento){
    
    if(elemento.prioridad == 3){
        
        insertarPrioridad3(tad,elemento);
    }
    else if(elemento.prioridad == 2)
        insertarPrioridad2(tad,elemento);
    else insertarPrioridad1(tad,elemento);
    
}


void insertarPrioridad3(struct Lista & tad, const struct Elemento & elemento){
    
    Nodo *nuevoNodo = crearNodo(elemento, nullptr);
    
    if(tad.cabeza == nullptr and tad.colaCat1 == nullptr and 
            tad.colaCat2 == nullptr and tad.colaCat3 == nullptr){
        tad.cabeza  = nuevoNodo;
    }
    else if(tad.colaCat3 != nullptr){
        tad.colaCat3->siguiente = nuevoNodo;
    }
    else if(tad.colaCat2 == nullptr and tad.colaCat3 == nullptr){
        tad.colaCat1->siguiente = nuevoNodo;
    }
    else if(tad.colaCat2 != nullptr and tad.colaCat3 == nullptr){
        tad.colaCat2->siguiente = nuevoNodo;
    }
    tad.colaCat3 = nuevoNodo;
}


void insertarPrioridad2(struct Lista & tad, const struct Elemento & elemento){
    ...
    else if(tad.colaCat2 != nullptr){
        nuevoNodo->siguiente = tad.colaCat2->siguiente;
        tad.colaCat2->siguiente = nuevoNodo;
    }
    else if(tad.colaCat1 == nullptr and tad.colaCat2 == nullptr){
        nuevoNodo->siguiente = tad.cabeza;
        tad.cabeza = nuevoNodo;
    }
    else if(tad.colaCat1 != nullptr and tad.colaCat2 == nullptr){
        nuevoNodo->siguiente = tad.colaCat1->siguiente;
        tad.colaCat1->siguiente = nuevoNodo;
    }
    tad.colaCat2 = nuevoNodo;
    
}


void insertarPrioridad1(struct Lista & tad, const struct Elemento & elemento){
    ...
    else if(tad.colaCat1 != nullptr){
        nuevoNodo->siguiente = tad.colaCat1->siguiente;
        tad.colaCat1->siguiente = nuevoNodo;
    }
    else if(tad.colaCat1 == nullptr and (tad.colaCat2 != nullptr or
            tad.colaCat3 != nullptr)){
        nuevoNodo->siguiente = tad.cabeza;
        tad.cabeza = nuevoNodo;
    }
    
    tad.colaCat1 = nuevoNodo;
}