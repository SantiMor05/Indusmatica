...
//void insertarConPrioridad(struct Lista &lista, const Elemento &elemento){
//    struct Nodo * nuevoNodo = crearNodo(elemento, nullptr);
//    if (esListaVacia(lista)){
//        lista.cabeza = nuevoNodo;
//        lista.cola = nuevoNodo;
//        if (nuevoNodo->elemento.tipo==1) lista.VIP = nuevoNodo;
//    }else{
//        if (nuevoNodo->elemento.tipo==1){
//            if (lista.VIP==nullptr){
//                nuevoNodo->siguiente = lista.cabeza;
//                lista.cabeza = nuevoNodo;
//            }else{
//                nuevoNodo->siguiente = lista.VIP->siguiente;
//                lista.VIP->siguiente = nuevoNodo;
//                if (lista.cola->elemento.tipo==1) lista.cola = nuevoNodo;
//            }
//            lista.VIP = nuevoNodo;
//        }else{
...
//            cout<< recorrido->elemento.tipo<<"-";
            cout << recorrido->elemento.numero << "     "<<recorrido->elemento.horaI/100<<":"<<
                    recorrido->elemento.horaI%100<<"       "<<
                    recorrido->elemento.horaF/100<<":"<<recorrido->elemento.horaF%100<<endl;
            recorrido = recorrido->siguiente;
        }
//        cout << "]" << endl;
    }
