...
void apilar(struct Pila & pila, struct NodoArbol *&nodoA) {
    insertarAlInicio(pila.lista, nodoA);
    cout << "Apilando: " << nodoA->elemento.numero << endl;
}

/* Pop, elimina un elemento de la parte superior de la pila*/

struct NodoArbol * desapilar2(struct Pila & pila) {
    ...
    struct NodoArbol *nodoA=pila.lista.cabeza->nodoA;
