...
//void insertarAlInicio(struct Lista &, struct Pedido elemento);
void insertarAlFinal(struct Lista &, struct Pedido elemento);
//void insertarEnOrden(struct Lista &, int);

struct Nodo * crearNodo(const struct Pedido & elemento, struct Nodo *);
