...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/alg_ex1_23-1-p1-yoshi.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/alg_ex1_23-1-p1-yoshi.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/alg_ex1_23-1-p1-yoshi ${OBJECTFILES} ${LDLIBSOPTIONS}
