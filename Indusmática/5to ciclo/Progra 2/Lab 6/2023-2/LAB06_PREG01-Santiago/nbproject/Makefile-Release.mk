...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab06_preg01-santiago.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab06_preg01-santiago.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab06_preg01-santiago ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Producto.o: Producto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Producto.o Producto.cpp

${OBJECTDIR}/ProductoEntregado.o: ProductoEntregado.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProductoEntregado.o ProductoEntregado.cpp
