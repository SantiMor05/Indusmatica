...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab10-23-1-santiago.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab10-23-1-santiago.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab10-23-1-santiago ${OBJECTFILES} ${LDLIBSOPTIONS}
