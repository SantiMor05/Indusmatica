...
CREATE TABLE ET_TICKET (
    ID_TICKET_VIAJE     NUMBER NOT NULL,
...
COMMENT ON COLUMN ET_TICKET.ID_TICKET_VIAJE IS
...
ALTER TABLE ET_TICKET ADD CONSTRAINT ET_TICKET_PK PRIMARY KEY ( ID_TICKET_VIAJE );
